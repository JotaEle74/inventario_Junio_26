...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/configuracion', component: () => import ('pages/Configuracion/ConfiguracionPage.vue')},
      ...
      { path: '/software/reporte', component: ()=> import('pages/Software/SoftwareReportePage.vue')},
      { path: '/acta-verificacion', component: ()=> import('pages/Inventariador/ActaPage.vue')},
    ]
  },
