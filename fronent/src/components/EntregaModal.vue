                ...
                <div class="row q-col-gutter-md">
                  ...
                  <div class="col-12 col-lg-8">
                    <div class="row q-col-gutter-sm">
                      <div class="col-12 col-md-6">
                        <div><span class="text-weight-bold text-primary">Activo: </span>{{ activo.denominacion }}</div>
...
const search_oficina = async (val, update) => {
  ...
  update(() => {
    usuarioEntrega.value.oficinas = oficinas.map(oficina => ({
      id: oficina.id,
      nombre: `${oficina.codigo} - ${oficina.denominacion}`,
      label: oficina.denominacion,
      value: oficina.id,
    }))
  })
}
  ...
  try {
    const data = {
      ...
      usuario: {
        ...
        oficina: oficinaUsuarioSeleccionada.value.label
      },
      auto_autorizar: true
    }
