...
const modernFormFields = ref([
  ...
  ...((auth.isAdmin)?[
  { name: 'password', type: 'password', label: 'Nueva Contraseña', placeholder: 'Ingrese la nueva contraseña', prepend: 'lock', vIf: 'updatePassword' },
  { name: 'password_confirmation', type: 'password', label: 'Confirmar Contraseña', placeholder: 'Confirme la nueva contraseña', prepend: 'lock', vIf: 'updatePassword' }
  ]:[]),
])
