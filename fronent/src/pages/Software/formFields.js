...
export function useSoftwareForm(formData) {
  ...
  const tipoFields = {
    ...
    licencia_terceros: [
      ...
      { name: 'clave_licencia', type: 'text', label: '#MAC', prepend: 'key' },
      { name: 'tipo_licencia', type: 'text', label: 'Tipo de Licencia', prepend: 'receipt_long'},
      ...
      //},
      { name: 'version', type: 'text', label: 'Version', prepend: 'group' },
      { name: 'fecha_compra', type: 'date', label: 'Fecha de Instalación', prepend: 'event' },
      ...
      { name: 'notas', type: 'textarea', label: 'Sistema operativo/caracteristicas', autogrow: true, prepend: 'notes' },
    ],
    red_social: [
